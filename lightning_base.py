...
def add_generic_args(parser):
    ...
    parser.add_argument("--do_generate", action="store_true", help="Whether to run generations on the test set.")
    parser.add_argument("--do_infer", action="store_true", help="Whether to run inference on the test set.")
    parser.add_argument("--do_test", action="store_true", help="Whether to run prediction on the test set.")
    ...
    parser.add_argument("--train_dataset_path", type=str, default="", help="Path or url of the train dataset.")
    parser.add_argument("--eval_dataset_path", type=str, default="", help="Path or url of the validation dataset.")
    parser.add_argument("--test_dataset_path", type=str, default="", help="Path or url of the test dataset.")
    parser.add_argument("--predict_dataset_path", type=str, default="", help="Path or url of the predict dataset.")
